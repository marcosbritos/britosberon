...
const tags = ["Peluquerías","Estudios profesionales","Consultorios","Talleres mecánicos","Servicios técnicos","Kioscos y minimarkets","Lavaderos","Locales gastronómicos","Cursos y profesores","Veterinarias"];
