  ...
  return (
    <section className="relative px-5 md:px-[56px] pt-10 md:pt-[80px] pb-14 md:pb-[100px] border-b border-ink/10 bg-bone">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-12 md:gap-[64px] items-start">
        <div>
          ...
          <div className="mt-8 md:mt-[42px] flex flex-col sm:flex-row gap-3 md:gap-5 items-stretch sm:items-center">
            <a
              ...
              aria-label="Quiero una demo por WhatsApp"
        ...
        {/* Card de polaroid — sin rotación en mobile (rompía padre overflow), rotación solo desde lg */}
        <div className="flex justify-center lg:justify-end pt-4 lg:pt-[60px]">
          <div className="bg-[#f8f8f8] p-3 sm:p-4 pb-10 sm:pb-12 shadow-2xl lg:-rotate-2 hover:rotate-0 transition-transform duration-500 max-w-[260px] sm:max-w-[300px] border border-ink/10">
            <div className="w-full aspect-[9/16] overflow-hidden border border-ink/10 relative">
              <img src="/torneo-foto.png" alt="Tabla general de un torneo amateur en la plataforma" className="w-full h-full object-cover object-top" />
            </div>
